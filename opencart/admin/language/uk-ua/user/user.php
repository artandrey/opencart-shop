...
$_['error_exists_email']    = 'Таку адресу електронної пошти вже зареєстровано';
$_['error_single_user']     = 'Ви не можете відключити обліковий запис, в якому наразі знаходитесь';